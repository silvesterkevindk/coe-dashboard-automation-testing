...
const PROJECT_FIELDS = ['name', 'projectId', 'applicationId', 'phase', 'platform', 'progress', 'totalTC', 'executed', 'passed', 'failed', 'blocked', 'notRun', 'automation', 'automationCoverage', 'openDefect', 'closedDefect', 'critical', 'dailyProgress', 'urlGitlab', 'urlReport', 'urlTestcaseScenario', 'division', 'kontrak', 'stage']
const RESOURCE_FIELDS = ['name', 'npp', 'company', 'birthDate', 'joinDate', 'phone', 'role', 'jabatan', 'lead', 'kontrak', 'stage', 'projects', 'phase', 'todayTask', 'status', 'workload', 'utilization', 'progress', 'manualProgress', 'automationProgress', 'reviewProgress', 'activities', 'standup']
